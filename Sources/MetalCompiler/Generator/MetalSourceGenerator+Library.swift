...
extension MetalSourceGenerator {
    ...
    public static func generateCompleteLibrary(
        ...
        sources.append(generateVocabGEMVBlocked8x128(name: "gemv_vocab_blocked8x128_bf16", bufferPrecision: decode, weightFormat: .bfloat16))
        ...
        sources.append(generateResidualRMSRouterParallelBF16ArgumentTableVariant(name: "residual_rms_router_parallel_bf16_sigmoid_argbuf", argumentBufferIndex: 30))
        ...
        sources.append(generateSSMRecurrenceSequence(name: "ssm_recurrence_seq_bf16_f32_cached_params", bufferPrecision: prefill, weightFormat: .bfloat16, convDimension: defaultConvDimension, maxThreadgroupSize: defaultMaxThreadgroupSize, headCount: defaultHeadCount, groupCount: defaultGroupCount, keyHeadDimension: defaultKeyHeadDimension, valueHeadDimension: defaultValueHeadDimension, cacheHeadParameters: true))
        sources.append(generateSSMRecurrenceSequence(name: "ssm_recurrence_seq_bf16_f32_parallel_state", bufferPrecision: prefill, weightFormat: .bfloat16, convDimension: defaultConvDimension, maxThreadgroupSize: defaultMaxThreadgroupSize, headCount: defaultHeadCount, groupCount: defaultGroupCount, keyHeadDimension: defaultKeyHeadDimension, valueHeadDimension: defaultValueHeadDimension, parallelStateUpdate: true))
        sources.append(generateSSMRecurrenceSequence(name: "ssm_recurrence_seq_bf16_f32_parallel_state_shared_rms", bufferPrecision: prefill, weightFormat: .bfloat16, convDimension: defaultConvDimension, maxThreadgroupSize: defaultMaxThreadgroupSize, headCount: defaultHeadCount, groupCount: defaultGroupCount, keyHeadDimension: defaultKeyHeadDimension, valueHeadDimension: defaultValueHeadDimension, shareRMSScale: true, parallelStateUpdate: true))
        sources.append(generateSSMRecurrenceSequence(name: "ssm_recurrence_seq_bf16_f32_parallel_state_coalesced", bufferPrecision: prefill, weightFormat: .bfloat16, convDimension: defaultConvDimension, maxThreadgroupSize: defaultMaxThreadgroupSize, headCount: defaultHeadCount, groupCount: defaultGroupCount, keyHeadDimension: defaultKeyHeadDimension, valueHeadDimension: defaultValueHeadDimension, parallelStateUpdate: true, coalescedStateThreadMapping: true))
        sources.append(generateSSMRecurrenceSequence(name: "ssm_recurrence_seq_bf16_f32_group_owned_partial", bufferPrecision: prefill, weightFormat: .bfloat16, convDimension: defaultConvDimension, maxThreadgroupSize: defaultMaxThreadgroupSize, headCount: defaultHeadCount, groupCount: defaultGroupCount, keyHeadDimension: defaultKeyHeadDimension, valueHeadDimension: defaultValueHeadDimension, emitsGroupOwnedPartialProjection: true))
        sources.append(generateSSMRecurrenceSequence(name: "ssm_recurrence_seq_bf16_f32_partition_owned_partial", bufferPrecision: prefill, weightFormat: .bfloat16, convDimension: defaultConvDimension, maxThreadgroupSize: defaultMaxThreadgroupSize, headCount: defaultHeadCount, groupCount: defaultGroupCount, keyHeadDimension: defaultKeyHeadDimension, valueHeadDimension: defaultValueHeadDimension, emitsPartitionOwnedPartialProjection: true))
