...
| `MetalSourceGeneratorTests` | 34/34 pass after adding Q8, batched Q4, dense decode GEMV, argument-table decode GEMV, specialized decode GEMV, and unified quantized decode GEMV row-tail coverage |
